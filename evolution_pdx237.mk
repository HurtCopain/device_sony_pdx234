...
PRODUCT_BRAND := Sony
PRODUCT_MODEL := Pdx237

PRODUCT_GMS_CLIENTID_BASE := android-google

PRODUCT_BUILD_PROP_OVERRIDES += \
    PRIVATE_BUILD_DESC="XQ-DE54-user 13 67.0.A.6.60 TKQ1.221114.001 release-keys" \
    PRODUCT_BRAND=Sony \
    TARGET_DEVICE=pdx237 \
    PRODUCT_MANUFACTURER=Sony \
    PRODUCT_MODEL=Pdx237 \
    TARGET_PRODUCT=pdx237 \
    PRODUCT_SYSTEM_BRAND=Sony \
    PRODUCT_SYSTEM_DEVICE=pdx237 \
    PRODUCT_SYSTEM_MANUFACTURER=Sony \
    PRODUCT_SYSTEM_MODEL=Pdx237 \
    PRODUCT_SYSTEM_NAME=pdx237

BUILD_FINGERPRINT := Sony/XQ-DE54/XQ-DE54:13/67.0.A.6.60/TKQ1.221114.001:user/release-keys
